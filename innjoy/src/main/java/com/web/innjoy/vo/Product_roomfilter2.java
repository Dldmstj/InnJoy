...
public class Product_roomfilter2 {
	...
	public Product_roomfilter2() {
		super();
		// TODO Auto-generated constructor stub
	

	}
	public Product_roomfilter2(String pro_type, int pro_type_id, int pro_id, String pro_name, String pro_loc,
			String basic_info, String res_ann, String ser_conts, int room_id, String room_name, int room_price,
			String checkin, String checkout, int min_cnt, int max_cnt, String smoking, String bed_cnt, String user_id,
			int user_cnt, String start_dt, String end_dt, int payment, int status, String fname) {
		super();
