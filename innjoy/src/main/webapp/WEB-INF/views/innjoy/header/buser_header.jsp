                    ...
                    <div class="col-lg-3 d-lg-block d-none">
                        <div class="announcement-meta-wrapper d-flex align-items-center justify-content-end">
                            <div class="announcement-meta d-flex align-items-center">
                                ...
                                <a class="announcement-login announcement-text text-white" href="/bsn_acc">
                                    <span>MyPage</span>
                                </a>
                                <span class="separator-login d-flex px-3">
                                    <svg width="2" height="9" viewBox="0 0 2 9" fill="none"
                                ...
                                <ul class="main-menu list-unstyled justify-content-center">
                                	<li class="menu-list-item nav-item has-dropdown">
                                        <div class="mega-menu-header">
                                            <a class="nav-link" href="blog.html">숙소 관리</a>
                                        ...
                                        <div class="submenu-transform submenu-transform-desktop">
                                            <ul class="submenu list-unstyled">
                                                <li class="menu-list-item nav-item-sub">
                                                    <a class="nav-link-sub nav-text-sub" href="/regi1">숙소 등록</a>
                                                </li>
                                                <li class="menu-list-item nav-item-sub">
                                                    <a class="nav-link-sub nav-text-sub" href="/bsnList">숙소 등록 현황</a>
                                                </li>
                                            </ul>
                                        </div>
                                    <li class="menu-list-item nav-item">
                                        <a class="nav-link" href="/bsn_res">예약관리</a>
                                    </li>
                                    <li class="menu-list-item nav-item">
                                        <a class="nav-link" href="/bsnReviewMng">후기관리</a>
                                    </li>
                                    <li class="menu-list-item nav-item">
                                        <a class="nav-link" href="/bsn_inq">1:1 문의</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
