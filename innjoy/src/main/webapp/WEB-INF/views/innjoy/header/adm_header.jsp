                                ...
                                <ul class="main-menu list-unstyled justify-content-center">
                                    <li class="menu-list-item nav-item has-megamenu">
                                        <div class="mega-menu-header">
                                            <a class="nav-link" href="adm_user">
                                                회원 관리
                                            </a>
                                                    ...
                                                    <li class="menu-list-item nav-item-sub">
                                                        ...
                                                        <div class="submenu-transform megamenu-transform">
                                                            <ul class="megamenu list-unstyled">
                                                                <li class="menu-list-item nav-item-sub">
                                                                    <a class="nav-link-sub nav-text-sub"
                                                                        href="product.html">사업자회원 목록</a>
                                                                </li>
                                                                <li class="menu-list-item nav-item-sub">
                                                                    <a class="nav-link-sub nav-text-sub"
                                                                        href="product.html">사업자회원 신고목록</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="menu-list-item nav-item-sub">
                                                        ...
                                                        <div class="submenu-transform megamenu-transform">
                                                            <ul class="megamenu list-unstyled">
                                                                <li class="menu-list-item nav-item-sub">
                                                                    <a class="nav-link-sub nav-text-sub"
                                                                        href="product.html">위조이 글 관리</a>
                                                                </li>
                                                                <li class="menu-list-item nav-item-sub">
                                                                    <a class="nav-link-sub nav-text-sub"
                                                                        href="product.html">위조이 댓글 관리</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                    ...
                                    <li class="menu-list-item nav-item">
                                        <a class="nav-link" href="adm_faq">공지사항</a>
                                    </li>
                                    <li class="menu-list-item nav-item">
                                        <a class="nav-link" href="contact.html">1대1 문의</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
