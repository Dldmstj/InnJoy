...
<jsp:include page="../header/adm_header.jsp" flush="true" />
	<div>
		...
		<div class="member">
			<!-- 이름 & 아이디로 서치 -->
			<div class="title"><h2>일반회원 신고목록</h2></div>
			...
			<div class="member_list">
				<table class="admin_board_wrap">
					<tbody class="admin_boardList">
						...
						<th class="admin_board_head">신고횟수</th>
						<th class="admin_board_head">신고처리</th>
					...
					<tbody>
						<tr class="admin_board_content">
							...
							<td class="admin_board_content_nm">3</td>
							<td class="admin_board_content_nm">
							<button type="button" class="onclick_button">보류</button>
							<button type="button" class="out_onclick_button">탈퇴</button>
							</td>
							</a>
						</tr>
						<tr class="admin_board_content">
								...
								<div class="mypage_form">
									...
									<div class="insert">
										...
										<div class="tel_box">
											...
											<input type="text" name="e-mail" readonly value="hong@gmail.com"><br>
										</div>
										<!--현재 상태 구분-->
										<div class="job_box">
											&nbsp;
