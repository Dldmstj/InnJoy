		...
		<div class="row justify-content-center">
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="p-4">
									...
									<br>
									<button type="button" class="float-left " data-bs-toggle="modal" 
												data-bs-target="#uptModal">정보수정</button>
								</div>
							</div>
						</div>
					</div>
			...
			<nav>
				<div class="nav nav-tabs nav-justified" id="nav-tab" role="tablist">
					<a class="nav-item nav-link active" id="nav-res-tab" data-toggle="tab" href="#nav-res" role="tab"
						aria-controls="nav-res" aria-selected="true">예약내역</a>
					<a class="nav-item nav-link" id="nav-wish-tab" data-toggle="tab" href="#nav-wish" role="tab"
						aria-controls="nav-wish" aria-selected="false">❤️찜</a>
					<a class="nav-link" href="/myboardlist" aria-controls="nav-contact" aria-selected="false">활동내역</a>
				</div>
			</nav>
								...
								<div class="col mb-5">
									<div class="card h-100">
										...
										<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
											<div class="text-center">
												<a class="btn btn-outline-dark mt-auto" href="/product_detail">View Details</a>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="container px-4 px-lg-5 mt-5">
							<div
								...
								<div class="col mb-5">
									<div class="card h-100">
										<!-- Product image-->
										<img class="card-img-top" src="https://image.goodchoice.kr/resize_490x348/affiliate/2020/06/30/5efaee66a9fdb.jpg"
											alt="..." />
										<!-- Product details-->
										<div class="card-body p-4">
											<div class="text-center">
								...
								<div class="col mb-5">
									<div class="card h-100">
										<!-- Product image-->
										<img class="card-img-top" src="https://image.goodchoice.kr/resize_490x348/affiliate/2020/07/01/5efc420c3609d.jpg"
											alt="..." />
										<!-- Product details-->
										<div class="card-body p-4">
											<div class="text-center">
								...
								<div class="col mb-5">
									<div class="card h-100">
										...
										<!-- Product image-->
										<img class="card-img-top" src="https://image.goodchoice.kr/resize_490x348/affiliate/2022/06/09/62a19394cdf9c.jpg"
											alt="..." />
										<!-- Product details-->
										<div class="card-body p-4">
											<div class="text-center">
												...
												-->
												<!-- Product price-->
												<span class="text-muted text-decoration-line-through">400,000 원</span>
												375,000원
											</div>
										</div>
										<!-- Product actions-->
									...
									<div class="pl-5 pr-5">
										<form class="modifForm">
												...
												<div class="form-group">
													<label>이름</label>
													<input type="text" class="form-control form-control-user" value="${userInfo.userName}"
														id="userName" name="userName"readonly>
												</div>
												<div class="form-group">
													<label>닉네임</label>
													<input type="text" class="form-control form-control-user" id="nName"
														value="${userInfo.nName}" name="nName" placeholder="닉네임을 입력하세요.">
													<small id="ck_nName"></small>
												</div>
												<div class="form-group">
													<label>비밀번호</label>
													<input type="password" class="form-control form-control-user"
														id="userPass" name="userPass" placeholder="비밀번호를 입력해주세요. (특수문자를 포함한 8~10자)">
													<small id="ck_userPass"></small>
												</div>
												<div class="form-group">
													<label>비밀번호 재입력</label>
													<input type="password" class="form-control form-control-user"
														id="repass" placeholder="비밀번호 재입력">
												...
												<div class="form-group">
													<label>전화번호</label>
													<input type="text" class="form-control form-control-user"
														id="userPhone" name="userPhone" value=" ${userInfo.userPhone}">
													<button type="button" class="float-right" id="idCheck">인증</button>
													<small id="ck_userPhone"></small>
												</div>
											<div class="form-group"></div>
											<button type="button" onclick="modify_check()" class="btn btn-outline-success btn-block mt-5" id="modBtn">수정하기</button>
										</form>
									</div>
								</div>
							</div>
