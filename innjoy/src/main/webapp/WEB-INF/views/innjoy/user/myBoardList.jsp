								...
								<c:if test="${not empty reservation.review}">
									<div class="col mb-3">
										<div class="d-flex flex-row card w-100">
											<!-- Product image-->
											<img class="card-img-top" src="${path}/upload/${reservation.review.reviewImg.get(0).fname}" alt="..." />
											<!-- Product details-->
					...
					<div class="container px-4 px-lg-5">
							<div class="row justify-content-center">
								...
								<div class="col mb-3">
									<div class="d-flex flex-row card w-100">
										<!-- Product image-->
										<img class="card-img-top" src="${path}/upload/${recomm.boardImg.get(0).fname}" alt="..." />
										<!-- Product details-->
