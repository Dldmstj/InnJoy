        ...
        <main id="MainContent" class="content-for-layout">
            ...
            <div class="slideshow-section position-relative">
                <div class="slideshow-active activate-slider" data-slick='{
                    ...
                    <div class="slide-item slide-item-bag position-relative">
                        <img class="slide-img d-none d-md-block" src="${path}/assets/img/innjoy_logo.jpg" alt="slide-1">
                        <img class="slide-img d-md-none" src="${path}/assets/img/innjoy_logo.jpg" alt="slide-1">
                    ...
                    <div class="slide-item slide-item-bag position-relative">
                        <img class="slide-img d-none d-md-block" src="${path}/assets/img/innjoy_logo.jpg" alt="slide-2">
                        <img class="slide-img d-md-none" src="${path}/assets/img/innjoy_logo.jpg" alt="slide-2">
                        <div class="content-absolute content-slide">
                            <div class="container height-inherit d-flex align-items-center justify-content-end">
                    ...
                    <div class="slide-item slide-item-bag position-relative">
                        <img class="slide-img d-none d-md-block" src="${path}/assets/img/innjoy_logo.jpg" alt="slide-3">
                        <img class="slide-img d-md-none" src="${path}/assets/img/innjoy_logo.jpg" alt="slide-3">
                        <div class="content-absolute content-slide">
                    ...
                    <div class="container">
                        <div class="grid-container-2">
                            <a class="grid-item grid-item-1 position-relative rounded mt-0 d-flex" href="collection-left-sidebar.html"
                                ...
                                <img class="banner-img rounded" src="${path}/assets/img/innjoy_logo.jpg" alt="banner-1">
                                <div class="content-absolute content-slide">
                                    <div class="container height-inherit d-flex">
                                        <div class="content-box banner-content p-4">
                                            <h2 class="heading_34 primary-color">Inn <br>Joy!</h2>
                                            <p class="text_14 mt-2 primary-color">반가워요 처음이신가요?</p>
                                ...
                                <div class="content-absolute content-slide">
                                    <div class="container height-inherit d-flex justify-content-end">
                                        <div class="content-box banner-content p-4 text-end">
                                            <h2 class="heading_34 primary-color">We Joy! <br>Together</h2>
                                            <p class="text_14 mt-2 primary-color">친구들의 명소 추천 이야기!</p>
                                            <span class="text_12 mt-4 link-underline d-block primary-color">
                                                VIEW MORE
                                            </span>
                                        </div>
                            ...
                            <a class="grid-item grid-item-3 position-relative rounded mt-0 d-flex" href="collection-left-sidebar.html"
                                ...
                                <div class="content-absolute content-slide">
                                    <div class="container height-inherit d-flex">
                                        <div class="content-box banner-content p-4">
                                            <h2 class="heading_34 primary-color">신규 숙소 <br>입점 이벤트</h2>
                                            <p class="text_14 mt-2 primary-color">사장님은 몰라</p>
                                            <span class="text_12 mt-4 link-underline d-block primary-color">
                                                VIEW MORE
                                            </span>
                                        </div>
                ...
                <div class="collection-tab-inner">
                    <div class="container">
                        ...
                        <div class="row">
                                ...
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="https://image.goodchoice.kr/resize_490x348/affiliate/2020/07/01/5efc420c3609d.jpg"
                                                alt="product-img">
                                            <img class="primary-img" src="https://image.goodchoice.kr/resize_490x348/affiliate/2020/07/01/5efc420c3609d.jpg"
                                                alt="product-img">
                                        </a>

                                        <div class="product-badge">
                                            <span class="badge-label badge-percentage rounded">호텔</span>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="https://image.goodchoice.kr/resize_490x348/affiliate/2020/06/30/5efaee66a9fdb.jpg"
                                                alt="product-img">
                                            <img class="primary-img" src="https://image.goodchoice.kr/resize_490x348/affiliate/2020/06/30/5efaee66a9fdb.jpg"
                                                alt="product-img">
                                        </a>
                            ...
                            <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="https://image.goodchoice.kr/resize_490x348/affiliate/2023/06/21/11/68f9e4f1694a45948b2d4b8140a02328.jpg"
                                                alt="product-img">
                                            <img class="primary-img" src="https://image.goodchoice.kr/resize_490x348/affiliate/2023/06/21/11/68f9e4f1694a45948b2d4b8140a02328.jpg"
                                                alt="product-img">
                                        </a>
                        ...
                        <div class="view-all text-center" data-aos="fade-up" data-aos-duration="700">
                            <a class="btn-primary" id="btn" href="#">VIEW ALL</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="scattered-item" data-aos="fade-left" data-aos-duration="700">
                                <div class="scattered-wrapper">
                                    <div class="scattered-content">
                                        <img class="scattered-img" src="${path}/assets/img/innjoy_logo.jpg" alt="img">
                                    </div>
                                    ...
                                    <div class="testimonial-slideshow common-slider" data-slick='{
                                        ...
                                        <div class="testimonial-item">
                                            ...
                                            <p class="testimonial-review my-4 text_16">
                                                “ 숙소가 구려요 하지만 가격이 저렴해서 별 다섯개 드립니다.”
                                            </p>
                                            <div class="testimonial-reviewer d-flex align-items-center">
                                                ...
                                                <div class="reviewer-info ms-4">
                                                    <h4 class="reviewer-name heading_18 mb-2 primary-color">닉네임은 없다
                                                    </h4>
                                                    <p class="reviewer-desig text_14 m-0">그랭드 하얀트</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="testimonial-item">
                                            ...
                                            <div class="testimonial-reviewer d-flex align-items-center">
                                                ...
                                                <div class="reviewer-info ms-4">
                                                    <h4 class="reviewer-name heading_18 mb-2 primary-color">집에 보내줘
                                                    </h4>
                                                    <p class="reviewer-desig text_14 m-0">홈타운</p>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="single-banner-section mt-100 overflow-hidden">
                <div class="position-relative overlay">
                    <img class="single-banner-img" src="${path}/assets/img/innjoy_logo.jpg" alt="slide-1">
                                ...
                                <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                                    <div class="article-card bg-transparent p-0 shadow-none">
                                        <a class="article-card-img-wrapper" href="article.html">
                                            <img src="${path}/assets/img/innjoy_logo.jpg" alt="img"
