                        ...
                        <div class="row justify-content-center trusted-row">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="trusted-badge rounded p-0">
                                    ...
                                    <div class="trusted-content">
                                        <h2 class="heading_18 trusted-heading">반가워요 ${ij_user.nName}고객님!</h2>
							    ...
							    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
							        ...
							        <div class="product-card">
							            <div class="product-card-img">
							                <a class="hover-switch" href="${path}/product_detail?pro_id=${product.product.pro_id}&start_dt=&end_dt=&user_cnt=">
                                    ...
                                    <div class="product-card-details">
						                <h3 class="product-card-title">
						                    <a href="${path}/product_detail?pro_id=${product.product.pro_id}&start_dt=&end_dt=&user_cnt=">${product.product.pro_name}</a>
						                </h3>
